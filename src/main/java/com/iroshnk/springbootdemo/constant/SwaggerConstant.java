package com.iroshnk.springbootdemo.constant;
...
public final class SwaggerConstant {
    ...
    public static final String API_BASE_PACKAGE = "com.iroshnk.springbootdemo";
    ...
    public static final String LICENSE = "Copyrights@iroshnk";
    public static final String LICENSE_URL = "https://github.com/IroshR";
    public static final String CONTACT_NAME = "Irosh Kuruppu";
    public static final String CONTACT_URL = "https://github.com/IroshR";
    public static final String CONTACT_EMAIL = "iroshnk@gmail.com";
